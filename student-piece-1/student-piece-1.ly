...
upper = \relative c' {
	...
	\clef treble
	\tupletSpan 8
	\tuplet 3/2 {r16 b'[ e] g[-- b, e] fs[-- as, ds] f[-- af, c] e[-- g, b] e[ g, b] e[ g, b] ds[-- fs,! b] |
	e16[-- g, b] g'[-- b, e] fs[-- as, ds] f[-- af, c] e[-- c e]} << { \stemDown \tuplet 3/2 {c'[ e, c} \tuplet 3/2 {ef c ef]} \tuplet 3/2 {b'[ ef, c]} } \\ { \stemUp c'4 b8~} >> |
	<< { \stemDown \tuplet 3/2 {e,?16[ c e]} \tuplet 3/2 {c'[ e, c} \tuplet 3/2 {ef c ef]} \tuplet 3/2 {b'[ ef, c} \tuplet 3/2 {e c e]} \tuplet 3/2 {c'[ e, c} \tuplet 3/2 {f c f]} \tuplet 3/2 {c'[ f, c]} } \\ { \stemUp b'8 c4 b c c8~ } >> |
	<< { \stemDown \tuplet 3/2 {fs,16 c fs c' fs, c fs c fs c fs r} } \\ { \stemUp c'8]\arpeggio c[~-> c16 b c cs] } >> \ottava #1 d4~ d16 fs, b c |
	...
	\tempo 4 = 56
	\clef treble
	\tuplet 3/2 { r16^\markup{"Tempo I"} a cs fs cs a r a cs fs cs a r a cs fs cs a r gs cs es cs gs |
	...
	b'-- fs d fs-- d b r d fs } d-- e-- \tuplet 3/2 { fs-- a, cs fs a, cs fs a, cs fs a, cs |
	r d fs b-- fs d d'-- b fs cs'-- a cs, a'-- fs d } gs-- a-- \tuplet 3/2 { b-- fs d a'-- fs cs |
	fs-- d b b'-- fs d fs-- d b } d-- e-- \tuplet 3/2 { fs-- a, cs fs a, cs fs a, cs fs a, cs |
	r d fs b-- fs d d'-- b fs cs'-- b f a-- f b, } g'-- a-- \tuplet 3/2 { b-- f d } a'8-- |
	\tuplet 3/2 { fs16-- d b b'-- fs d fs-- d b } d-- e-- << { \stemDown fs-- b,_\markup{"decelerating"} d cs as gs32 as cs16.-- b32 } \\ { \stemUp fs'4. e8 } >> |
...
lower = \relative c {
	...
	g16-- e' g fs ds cs32 ds e16 b << { \stemDown g4 a4 } \\ { \stemUp \tupletSpan 4 \tuplet 3/2 {e'8 fs e ds e ds} } >> |
	<< { \stemDown b4 c cs ds } \\ { \stemUp \tuplet 3/2 {e8 fs e ds e ds e8 fs e ds b' fs} } >> |
	...
	<< { \stemDown a,2\arpeggio } \\ { \stemUp d16 a' d, a' d, a' d, a' } >> \stemNeutral \tuplet 3/2 {r16 b,[ g' d' g, b,]} \tuplet 3/2 {fs'[ b, fs' d' fs, b,]} |
	\tuplet 3/2 {f'[ b, f' d' f, b,]} \tuplet 3/2 {e[ b e gs d' e,]} \tuplet 3/2 {r cs[ a' e' a, cs,]} \tuplet 3/2 {gs'[ cs, gs' e' gs, cs,]} |
	\tuplet 3/2 {g'[ cs, g' e' g, cs,]} \tuplet 3/2 {fs[ cs fs as e' fs,]} \tuplet 3/2 {r d[ fs b d fs,]} \tuplet 3/2 {r cs[ fs as cs fs,]} |
	\tuplet 3/2 {r c[ fs a d fs,]} \tuplet 3/2 {r b,[ fs' a ds fs,]} \tuplet 3/2 {r bf,[ c g' c g]} \clef bass \tuplet 3/2 {c,[ g c, g a as]} |
	...
	b fs'-- b-- \tuplet 3/2 { a16 gs g } fs8-- cs-- a16-- b-- cs8-- |
	gs fs' a, fs' b, fs'16 bs, cs8 \tuplet 3/2 { d16 e es } |
	fs8 b, fs'-- b-- fs-- cs-- a16-- b-- bs-- cs-- |
	b8 as a gs << { g4 g } \\ { g8 d' g, \tuplet 3/2 {d'16 e es} } >> |
